...
git clone https://github.com/Onelots-Devices-Playground/vendor_xiaomi_miuicamera-veux vendor/xiaomi/miuicamera-veux --depth=1

echo "Cloning BCR"
git clone https://github.com/sdm695dev/vendor_bcr vendor/bcr --depth=1

echo "Cloning Sony Dolby"
git clone https://github.com/sdm695dev/vendor_sony_dolby.git vendor/sony/dolby

echo "Cloning ViPER4AndroidFX"
git clone https://github.com/sdm695dev/packages_apps_ViPER4AndroidFX packages/apps/ViPER4AndroidFX
